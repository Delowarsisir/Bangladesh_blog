                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            @foreach($sliders as $slider)
                                <tr class="odd gradeX">
                                    ...
                                    <td><img src="{{ asset($slider->slider_image) }}" alt="" width="80" height="60"> </td>
                                    <td>
                                        ...
                                        <a href="{{ route('delete-slider', ['id' => $slider->id]) }}" class="btn btn-danger btn-sm" onclick="confirm('Are you sure this?')">
